...
const Login = ({authenticated}) => {
    ...
    return (
        <div className="login-container bg-blue-100 h-screen">
            <div className="login-content bg-blue-950">
                <h1 className="login-title">Please log in to Foo Air</h1>
                <SocialLogin/>
                <div className="or-separator">
                    <span className="or-text bg-blue-950">OR</span>
                </div>
                <LoginForm/>
                <span className="signup-link">
          New to the app?  <Link to="/signup">Sign up now!</Link>
        </span>
            </div>
        </div>
    );
